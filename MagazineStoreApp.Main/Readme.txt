...
notes: Business Layer uses internal functions to hide API calls to VertMarket from other projects.
       Newtonsoft json used for entity serializations
       Tasks for employed to further parallel calls during the loading of data, after token is called.
...
To Run Project:
 ...
 to Run EXE:
 1) go to Bin/debug/net 6.0 folder of project under MagazineStoreApp.Main
 2) run MagazineStoreApp.Main.exe
